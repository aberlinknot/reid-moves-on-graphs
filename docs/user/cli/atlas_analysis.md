...
Атлас NetworkX содержит 1253 графа с числом вершин от 0 до 7. Данный инструмент анализирует каждый граф в атласе и вычисляет:
...
3. **Застревание** — является ли граф "застрявшим" (нет ходов I и II)
